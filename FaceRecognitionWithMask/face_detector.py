...
class FaceDetector:
    def __init__(self):
         # 切换到CPU版本
        providers = ['CPUExecutionProvider']  # 使用CPU提供者
        self.ort_session = onnxruntime.InferenceSession("data/ssd_mini_w360.onnx", providers=providers)
    
    # load the model if have GPU
